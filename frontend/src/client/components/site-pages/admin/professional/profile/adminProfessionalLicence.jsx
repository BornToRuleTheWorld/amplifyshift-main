...
const AdminProfessionalLicense = (props) => {
    ...
    const prof_id = atob(localStorage.getItem('adminProfID')) || "";
    ...
    const validiteFormInputs = (data) => {
        ...
        if (Object.keys(data).length !== 0){
          ...
          }else if(!Number.isInteger(parseInt(data.license_number))){
                        ...
                        <div className="row align-items-center inner-banner">
                            <div className="col-md-12 col-12 text-center">
                                <nav aria-label="breadcrumb" className="page-breadcrumb">
                                    ...
                                    <h2 className="breadcrumb-title">Professional License</h2>
                                </nav>
                            </div>
                        </div>
                    </div>
                                                            ...
                                                            <table className="table table-center mb-0 table-striped table-hover">
                                                                <thead className="bg-primary text-white">
                                                                    <tr className="bg-primary text-white">
                                                                        <th className="bg-primary text-white">License Name</th>
...
export default AdminProfessionalLicense;
