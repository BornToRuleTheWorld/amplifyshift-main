...
import {AUTH_TOKEN, API_BASE_URL, fetchModules, workExperienceOptions, disciplineOptions, specialtyOptions, yearOptions, docOptions, langOptions, weeklyOptions, stateOptions, cntryOptions, ColourOption, SingleValue, MultiValueLabel } from '../../../config';
import { FaPen, FaPlusSquare, FaMinusCircle, FaPlusCircle } from "react-icons/fa";
import axios from "axios";

const AdminProfessionalProfile = (props) => {
  
  const email = atob(localStorage.getItem('adminProfEmail')) || "";
