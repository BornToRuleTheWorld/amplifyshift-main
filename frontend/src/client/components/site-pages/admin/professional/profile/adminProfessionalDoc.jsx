...
const AdminProfessionalDocument = (props) => {
    ...
    const updateStatus = async(id) => {
        ...
        try {
            await axios.patch(`${API_BASE_URL}/professional/document/${id}/`,data, {
                headers: { 
                    "Content-Type": "application/json",
                    'Authorization': AUTH_TOKEN
                },
            ...
            setError(err.response?.data?.Result || "Error verifying document");
        }
    }
                                                                        ...
                                                                        <tr key={document.id}>
                                                                            ...
                                                                            <td>
                                                                                <div className="action-item">
                                                                                    ...
                                                                                    <button className="btn btn-md btn-primary-gradient rounded-pill" onClick={(e) => {e.preventDefault(); updateStatus(document.id)}}>Verify</button>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    ))}
...
export default AdminProfessionalDocument;
