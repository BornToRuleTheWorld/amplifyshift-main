                  ...
                  <nav aria-label="breadcrumb" className="page-breadcrumb">
                    <ol className="breadcrumb">
                      ...
                      <li className="breadcrumb-item active">
                         <Link to="/site-user/jobs">Jobs</Link></li>
                    </ol>
                  ...
                  <div className="doctor-widget doctor-profile-two border-bottom">
                    <div className="doc-info-left">
                      ...
                      <div className="doc-info-cont">
                        ...
                        <b>License required</b> - {(jobData?.license) ? jobData?.license : "N/A" },  <b>CPR/BLS</b> - { (jobData?.cpr_bls) ? boolOption.map(option => {if (option.value == jobData?.cpr_bls) {return option.label;}return "";}): "N/A"},  <b>Pay</b> - ${jobData?.pay}</p>
