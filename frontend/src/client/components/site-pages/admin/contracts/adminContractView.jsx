...
const AdminContractViewPage = (props) => {
              ...
              <nav aria-label="breadcrumb" className="page-breadcrumb">
                <ol className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">
                    <Link to="/site-user/contracts">Contracts</Link>
                  </li>
                </ol>
              ...
              <div className="row text-center" >
                ...
                <div className="col-lg-6 text-start">
                  <div className="alert alert-primary alert-dismissible fade show" role="alert">
                    <div className="col-7">
                      <p><strong>Contract ID :</strong>&nbsp;000011/002212/2025</p>
                    ...
                    <div className="doctor-widget doctor-profile-two border-bottom">
                        ...
                        <div className="doc-info-cont">
                            ...
                            <p>
                              ...
                              <b>License required</b> - {data.job_license ? boolOption.map(option => {if (option.value == data.job_license) {return option.label;}return "";}) : "N/A"},&nbsp;  <b>CPR/BLS</b> - {data.job_cpr_bls ? boolOption.map(option => {if (option.value == data.job_cpr_bls) {return option.label;}return "";}) : "N/A"},&nbsp;  <b>Pay</b> - ${data.job_pay}
                            </p>
                            {/* <p><b>Experience required</b> - {yearOptions.map(year => {if (year.value === data.years_of_exp) {return year.label} return null })} years,  <b>License required</b> - Yes,  <b>CPR/BLS</b> - Yes,  <b>Pay</b> - $80</p> */}
...
export default AdminContractViewPage;
