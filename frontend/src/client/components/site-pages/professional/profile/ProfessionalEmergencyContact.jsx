...
const ProfessionalEmergencyContact = (props) => {
    ...
    //Alt contact
    const [altPhoneArea, setAltPhoneArea] = useState('')
    const [altPhonePrefix, setAltPhonePrefix] = useState('')
    const [altPhoneLine, setAltPhoneLine] = useState('')
    ...
    useEffect(() => {
        if (updateForm) {
            ...
            setAltPhoneArea(updateForm.alt_phone.slice(0,3))
            setAltPhonePrefix(updateForm.alt_phone.slice(3,6))
            setAltPhoneLine(updateForm.alt_phone.slice(6,10))
        }
    }, [updateForm]);
    ...
    const validiteFormInputs = (data) => {
        ...
        if (Object.keys(data).length !== 0){
            ...
            if ( altPhoneArea == '' || altPhonePrefix == '' || altPhoneLine == '') {
                errorObj.alt_phone = "Alternate phone number is required";
            } else {
                if (
                    !Number.isInteger(parseInt(altPhoneArea)) ||
                    !Number.isInteger(parseInt(altPhonePrefix)) ||
                    !Number.isInteger(parseInt(altPhoneLine))
                ) {
                    errorObj.alt_phone = "Invalid alternate number";
                }
            }

            if (altPhoneArea.length < 3 || altPhonePrefix.length < 3 || altPhoneLine.length < 4 ){
                errorObj.alt_phone = "Invalid alternate number";
            }
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(formValidate).length === 0) {
            ...
            try {
                const updatedFormData = { ...formData, type: formData.type.value, phone_number:`${phoneArea}${phonePrefix}${phoneLine}`, alt_phone:`${altPhoneArea}${altPhonePrefix}${altPhoneLine}` };
                        ...
                        <div className="row align-items-center inner-banner">
                            <div className="col-md-12 col-12 text-center">
                                <nav aria-label="breadcrumb" className="page-breadcrumb">
                                    ...
                                    <h2 className="breadcrumb-title">Emergency Contact</h2>
                                </nav>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="card">
                                        <div className="card-body">
                                            <div className="border-bottom pb-3 mb-3">
                                                <div className="form-label text-muted"><span className="text-danger">*</span>&nbsp;Minimum 2 contacts are required</div>
                                            </div>
                                            {error ? (
                                                                ...
                                                                <div className="row g-2">
                                                                    <div className="col-4">
                                                                        <input
                                                                            type="text"
                                                                            maxLength={3}
                                                                            name="alt_contact_phone_area"
                                                                            value={altPhoneArea}
                                                                            onChange={(e) => setAltPhoneArea(e.target.value)}
                                                                            className="form-control"
                                                                        />
                                                                    </div>
                                                                    <div className="col-4">
                                                                        <input
                                                                            type="text"
                                                                            maxLength={3}
                                                                            name="alt_contact_phone_prefix"
                                                                            value={altPhonePrefix}
                                                                            onChange={(e) => setAltPhonePrefix(e.target.value)}
                                                                            className="form-control"
                                                                        />
                                                                    </div>
                                                                    <div className="col-4">
                                                                        <input
                                                                            type="text"
                                                                            maxLength={4}
                                                                            name="alt_contact_phone_line"
                                                                            value={altPhoneLine}
                                                                            onChange={(e) => setAltPhoneLine(e.target.value)}
                                                                            className="form-control"
                                                                        />
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <table className="table table-center mb-0 table-striped table-hover">   
                                                                <thead className="bg-primary text-white">
                                                                    <tr className="bg-primary text-white">
                                                                        <th onClick={() => handleSort('name')} style={{ cursor: "pointer" }} className="bg-primary text-white">Contact Name {sortOrder === 'asc' ? '↑' : '↓'}</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    contact.map((contact) => (
                                                                        <tr key={contact.id}>
                                                                            ...
                                                                            <td>{`(${contact.phone_number.slice(0,3)})`}-{contact.phone_number.slice(3,6)}-{contact.phone_number.slice(6,10)}</td>
                                                                            <td>
...
export default ProfessionalEmergencyContact;
