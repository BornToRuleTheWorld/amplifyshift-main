...
const ProfessionalCertificate = (props) => {
    ...
    const [sortField, setSortField] = useState('certificate_name');
                                                        ...
                                                        <div className="col-lg-4 col-md-6">
                                                            ...
                                                            <div className="form-icon">
                                                                <DatePicker
                                                                    className="form-control datetimepicker"
                                                                    name="cert_exp_date"
                                                                    selected={formData.cert_exp_date}
                                                                    onChange={(date) =>setFormData({ ...formData, cert_exp_date : date.toISOString().split('T')[0]})}
                                                                    dateFormat="MM/dd/yyyy"
                                                                    placeholderText="MM:DD:YYY"
                                                                    showDayMonthYearPicker
                                                            ...
                                                            {formErrors.cert_exp_date && <div className="form-label text-danger m-1">{formErrors.cert_exp_date}</div>}
                                                            </div>
                                                        </div>
                                                        <div className="col-lg-4 col-md-6">
                                                            <div className="mb-3">
                                                            ...
                                                            <table className="table table-center mb-0 table-striped table-hover">
                                                                <thead className="bg-primary text-white">
                                                                    <tr className="bg-primary text-white">
                                                                        <th onClick={() => handleSort('certificate_name')} style={{ cursor: "pointer" }} className="bg-primary text-white">Certificate Name {sortOrder === 'asc' ? '↑' : '↓'}</th>
                                                                        <th onClick={() => handleSort('certificate_date')} style={{ cursor: "pointer" }} className="bg-primary text-white">Certificate Date {sortOrder === 'asc' ? '↑' : '↓'}</th>
