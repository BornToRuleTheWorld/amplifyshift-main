...
const ProfRequestListPage = (props) => {
    ...
    const setMessageDetails = async(id) =>{
  ...
  const updateStatus = async(id, status) =>{
    ...
    useEffect(() => {
        fetchJobRequestList();
    },[ProfID,srchSubmit,currentPage]);

  
    console.log("requestList",requestList)
    console.log("Searck keyword", srchKeyword)
            ...
            <div className="col-lg-12 col-xl-12">
              ...
              <form onSubmit={handleSearchSubmit}>
                <div className="row my-4 px-2">
                  ...
                  {/* <div className="row">
                    <input type='submit' className="btn btn-primary mt-4 col-auto" value='Search' style={{ zIndex: "0", pointerEvents: "auto" }} />
                    <input type='button' className="btn btn-primary mt-4 mx-2 col-auto" value='Clear' onClick={clearSearchValue} style={{ zIndex: "0" }} />
                    <input type='button' className="btn btn-primary mt-4 offset-auto col-auto" value={addSearch ? 'Remove' : 'Advance search'} onClick={handleAddSearch} style={{ zIndex: "0" }} />
                  </div> */}
                        ...
                        <div className="card-body p-0">
                          <div className="d-flex align-items-center justify-content-between border-bottom p-3">
                            <Link to="#" className="text-teal fw-medium fs-14">
                              No job request request data available
                            </Link>
                          </div>
                        </div>
                      </div>
                ...
                <div className="appointment-wrap">
                  <div className="row justify-content-end align-items-center border-bottom mb-0">
                    <div className="col-auto">
                      <p><Link to="#" className="text-primary" onClick={()=>handleRequestView(job.id,job.job_data.facility)}><i className="fa-solid fa-eye" />&nbsp;View</Link></p>
                    </div>
                    {job.status === "Open" ?
                    <>
                    <div className="col-auto">
                      <p><Link to="#" className="text-success" onClick={()=>updateStatus(job.id,"Interested")}><i className="fa-solid fa-check" />&nbsp;Interested</Link></p>
                    </div>
                    <div className="col-auto">
                      <p><Link to="#" className="text-danger" onClick={()=>updateStatus(job.id,"Not Interested")}><i className="fa-solid fa-xmark" />&nbsp;Reject</Link></p>
                    </div>
                    </>
                    : null}
                    <div className="col-auto">
                        <p><Link to="#" onClick={()=>setMessageDetails(job.id)} style={{fontWeight:"bolder"}} className="text-primary text-decoration-underline font-weight-bold">{expandedJobId === job.id ? "Hide" : "Show"}</Link></p>
                    </div>
                  </div>
                  <ul className="mt-4">
                    <li className="mb-1">
                    ...
                    <li className="mb-1">
                      <p>{job.facility.fac_first_name} {job.facility.fac_last_name}</p>
                    </li>
                    <li className="mb-1">
                      <p><Link to="#" onClick={()=>handleRequestView(job.id,job.job_data.facility)}>{job.job_data.job_title}</Link></p>
                    </li>
                    <li className="mb-1">
                      <p>
                      <i className="fa-solid fa-calendar-days" />&nbsp;
                  ...
                  <ul className="mb-2">
                    <div className="row text-sm">
                      ...
                      {/* <div className="col-auto text-end ms-auto">
                        <Link to="#" onClick={()=>setMessageDetails(job.id)} style={{fontWeight:"bolder"}} className="text-primary text-decoration-underline font-weight-bold">{expandedJobId === job.id ? "Hide" : "Show"}</Link>
                      </div> */}
                    </div>
                  </ul>
                </div>
                        ...
                        requestList.map((job) => (
                          ...
                          <tr key={job.id}>
                            ...
                            <td>
                              ...
                              <FaEye title="View job request" className="text-primary" style={{fontSize:"19px"}} onClick={()=>setMessageDetails(job.id,job.job_data.facility)}/>
                    ...
                    <ul>
                      ...
                      <ul>
                        ...
                        <li className="text-end">
                          <button className="btn btn-primary my-2" onClick={()=>setMessageDetails(jobs.id,jobs.facility_id)}> View Details</button>
                        </li>
...
export default ProfRequestListPage;
