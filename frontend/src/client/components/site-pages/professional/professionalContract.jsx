...
import Footer from "../login/loginFooter.jsx";
...
const ProfContractListPage = (props) => {
              ...
              <form onSubmit={handleSearchSubmit}>
                <div className="row my-4 px-2">
                  ...
                  {/* <div className="row">
                    ...
                    <Link className="text-primary text-decoration-underline mt-4 offset-8 col-auto"  onClick={handleAddSearch} style={{ zIndex: "0",fontWeight:"bolder" }}>{addSearch ? 'Hide search' : 'Advance search'}</Link>
                  </div> */}
              ...
              contractData.length === 0 ?
                ...
                <div className="appointment-wrap">
                  <ul>
                    ...
                    <li className="mb-1">
                      <p><Link to="#" onClick={()=>handleContractView(contract.id,contract.facility_id)}>{contract.job_data.job_title}</Link></p>
                    </li>
                    <li className="mb-1">
                      <p>
                    ...
                    <li className="mb-1">
                      ...
                      {contract.job_data.status === "Active"
                        ?
                        <Link to="#" className="text-success" style={{fontWeight:"bolder"}}>{contract.job_data.status}</Link>
                        :
                        <Link to="#" className="text-danger" style={{fontWeight:"bolder"}}>{contract.job_data.status}</Link>
                      }
                      </p>
                    </li>
                    <li className="mb-1">
                    ...
                    <li className="mb-1">
                      <p>
                        ...
                        <FaEye title="View Contract" className="text-primary" style={{fontSize:"19px"}} onClick={()=>handleContractView(contract.id,contract.facility_id)}/>
                        ...
                        contractData.map((contract) => (
                          ...
                          <tr key={contract.id}>
                            ...
                            <td>
                              ...
                              <FaEye title="View job request" className="text-primary" style={{fontSize:"19px"}} onClick={()=>handleContractView(contract.id,contract.facility_id)}/>
...
export default ProfContractListPage;
