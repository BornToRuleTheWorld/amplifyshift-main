...
const ProfRequestViewPage = (props) => {
    // Map
    ...
    const requestFacID = atob(localStorage.getItem('requestFacID')) || "";
                ...
                <nav aria-label="breadcrumb" className="page-breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active">
                      <Link to="/professional/job-requests">Job Requests</Link>
                    </li>
                  </ol>
                ...
                
                {
                    ...
                    <div className="row mx-2 mb-4">
                      <div className="col-12 d-flex justify-content-end">
                        <button onClick={() => updateStatus('Interested')} className="btn btn-success mx-2">Interested</button>
                        <button onClick={() => updateStatus('Not Interested')} className="btn btn-danger mx-2">Not Interested</button>
                      </div>
                    </div>                  
                    :null} */}
                      ...
                      <li>
                        <div className="patinet-information" style={{minWidth:"0px"}}>
                          <div className="patient-info">
                            <p>Facility</p>
                            <h6>
                            <Link to="#">{data.facility_name}</Link>
                            </h6>
                          </div>
                        </div>
                      </li>
...
export default ProfRequestViewPage;
