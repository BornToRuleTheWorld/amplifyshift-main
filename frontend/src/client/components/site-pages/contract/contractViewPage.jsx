...
const ContractViewPage = (props) => {
  ...
  const contractProfID = atob(localStorage.getItem('contractProfID')) || "";
              ...
              <nav aria-label="breadcrumb" className="page-breadcrumb">
                <ol className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">
                    <Link to="/facility/contracts">Contracts</Link> 
                  </li>
                </ol>
      ...
      <div className="content">
        ...
        <div className="container border border-1 rounded-4 shadow">
          <ContractMessage
            ...
            message_to = {contractProfID}
            FacID = {currentUser}
            ProfID = {contractProfID}
            UserRole = {"facility"}
          />
      </div>
      </div>
