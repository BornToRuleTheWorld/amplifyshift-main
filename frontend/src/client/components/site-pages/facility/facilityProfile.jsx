...
const FacilityProfile = (props) => {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        setPhoneArea(response.data.data.fac_contact_num.slice(0,3))
        setPhonePrefix(response.data.data.fac_contact_num.slice(3,6))
        setPhoneLine(response.data.data.fac_contact_num.slice(6,10))
  ...
  const handleSubmit = async(e) => {
    ...
    if (Object.keys(formValidate).length === 0) {
      const updatedData = {...facData, data:{...facData.data, fac_contact_num:`${phoneArea}${phonePrefix}${phoneLine}`}}
      setIsLoading(true)
      axios
        .put(`${API_BASE_URL}/facility/UpdateFacility/${userEmail}/`, updatedData.data, {
          headers: {
            'Content-Type': 'application/json',
            'Authorization': AUTH_TOKEN,
          },
                ...
                <>
                  <div className="card">
                    <div className="card-body">
                      <div className="border-bottom text-end pb-3 mb-3">
                              ...
                              <div className="mb-3">
                                ...
                                {editMode ? (
                                  <Select
                                    ...
                                    onChange={(selected) => setfacData({ 
                                        ...facData, 
                                        data: { 
                                        ...facData.data, 
                                        fac_wrk_exp: selected.value
                                        } 
                                    })}
