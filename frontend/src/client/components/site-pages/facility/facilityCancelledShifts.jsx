...
const FacilityCancelShifts = (props) => {
  ...
  const getContractHours = async(id) => {
    ...
    .then((response) => {
      console.log("Cancel response", response.data.con_search_options)
            ...
            <div className="row align-items-center inner-banner">
              <div className="col-md-12 col-12 text-center">
                <nav aria-label="breadcrumb" className="page-breadcrumb">
                  ...
                  <h2 className="breadcrumb-title">Cancelled Shifts</h2>
                </nav>
              </div>
            </div>
          </div>
...
export default FacilityCancelShifts;
