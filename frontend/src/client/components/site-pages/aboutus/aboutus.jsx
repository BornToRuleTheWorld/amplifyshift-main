              ...
              <div className="row align-items-end">
                <div className="col-lg-7 col-md-12">
                  <div className="section-inner-header way-inner-header mb-0">
                    <h2>Be on Your Way to Feeling Better with the AmplifyShift</h2>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                      sed do eiusmod tempor incididunt ut labore et dolore magna
                      aliqua.
                      ...
                      <div className="testimonial-info">
                        ...
                        <div className="testimonial-content">
                          ...
                          <div className="testimonial-details">
                            <p>
                              AmplifyShift exceeded my expectations in healthcare. The seamless
                              ...
                              recommend AmplifyShift for anyone seeking reliable and accessible
                              healthcare services..
                            </p>
                            <h6>
